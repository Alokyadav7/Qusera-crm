      ...
      <main className="flex-1 p-4 md:p-6 space-y-4">
        ...
        {tasks.length > 0 && (
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Badge variant="outline" className="cursor-pointer hover:bg-muted bg-red-50 text-red-700 border-red-200">
              Overdue ({overdueTasks})
            </Badge>
            <Badge variant="outline" className="cursor-pointer hover:bg-muted bg-amber-50 text-amber-700 border-amber-200">
              Today ({todayTasks})
            </Badge>
            <Badge variant="outline" className="cursor-pointer hover:bg-muted bg-blue-50 text-blue-700 border-blue-200">
              Tomorrow ({tomorrowTasks})
            </Badge>
            <Badge variant="outline" className="cursor-pointer hover:bg-muted bg-emerald-50 text-emerald-700 border-emerald-200">
