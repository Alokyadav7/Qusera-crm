...
export default function Error({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center">
      ...
      <h2 className="text-xl font-bold mb-2">WhatsApp page error</h2>
      <p className="text-muted-foreground mb-6 max-w-sm text-sm">{error.message || 'Failed to load WhatsApp messages.'}</p>
